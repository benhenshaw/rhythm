...
### File Formats
As I intended to not rely on libraries for as many aspects of the project as possible, I also sought to write custom file readers. These file readers were intended to be simple, but facilitate all the features needed by the game.
...
**Assets live forever.** Graphics are loaded from disk and must be stored for the entire lifetime of them program.
